...
struct common_params {
    ...
    std::vector<common_control_vector_load_info> acap_vectors;  // activation capping axis (same GGUF format)
    int32_t acap_layer_start = -1; // layer range for activation capping
